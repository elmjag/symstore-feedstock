...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/symstore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7953&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/symstore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `symstore` can be installed with:

```
conda install symstore
```

It is possible to list all of the versions of `symstore` available on your platform with:
